...
parser.add_argument("--use_shapenet", action="store_true", help="Use SUN RGB-D V2 box labels.")
...
parser.add_argument(
    "--conf_thresh", type=float, default=0.05, help="Filter out predictions with obj prob less than it. [default: 0.05]"
)
parser.add_argument(
    "--faster_eval", action="store_true", help="Faster evaluation by skippling empty bounding box removal."
)
...
def evaluate_one_epoch():
    ...
    for i, ap_calculator in enumerate(ap_calculator_list):
        ...
        ## MATEJA-EVAL
        print("--- MATEJA ---")
        for key in metrics_dist_mateja:
            log_string("eval %s: %f" % (key, metrics_dist_mateja[key]))
